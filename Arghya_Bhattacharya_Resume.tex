...
{Jun. 2022 -- Aug. 2022}
{Network Structure and Security Research Lab, Bell Labs Core Research}
\resumeItemListStart
\item \justifying{Designing Machine Learning advised algorithms for low-latency live video streaming for 5G wireless networks.}
\resumeItemListEnd
...
\resumeItemListStart
\item \justifying{\textbf{Machine-learning augmentation:} Redesigned traditional online algorithms for rent-or-buy problems with augmentation by single and multiple machine learning oracles [2]; the journal version deals with a more generalized version of the problem with an arbitrarily fluctuating discount [3].
...
\item \justifying{\textbf{Cache-efficient algorithms:} Designed an empirical framework to evaluate when $(a,b,c)$-regular cache-oblivious algorithms are cache-efficient as external memory algorithms and do not degrade in the face of memory fluctuations that are common in most modern systems [1]. \href{https://github.com/ArghyaB118/cache_adaptivity}{\textbf{[code]}}} 
