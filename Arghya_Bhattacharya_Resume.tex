...
\section{Summary}
\justifying{I am a fifth-year doctoral candidate with experience in both academic research and industry. My thesis sheds light on how to design cache-friendly algorithms that breed both theoretical and practical advantages. These algorithms are helpful for shared memory and cloud systems. I also design machine-learning advised algorithms for traditional online decision-making problems.
I am actively looking for internship positions in applied sciences\ignore{ for Summer'23}, specifically, in the field of software engineering and machine learning.}
...
{Jun. 2022 -- Aug. 2022}
{Network Systems and Security Research Lab, Bell Labs Core Research}
\resumeItemListStart
\item \justifying{Designed out-of-band ML-based prediction augmented congestion control algorithms for low-latency, high-volume variable-bitrate applications (such as live video streaming) for 5G wireless network systems.}
\resumeItemListEnd
\resumeSubheading{Stony Brook University}{Stony Brook,NY}
{Research Project Assistant, Advisor: \href{https://www3.cs.stonybrook.edu/~bender/}{Prof. Michael A.\ Bender}, Collaborator: \href{https://www3.cs.stonybrook.edu/~rezaul/}{Rezaul A.\ Chowdhury}}
{Jun. 2019 -- Present}
{Algorithms Lab, Dept.\ of Computer Science}
\resumeItemListStart
\item \justifying{\textbf{Cache-efficient algorithms:} Designed an empirical framework to evaluate when $(a, b, c)$-regular algorithms (a class of recursive and cache-oblivious algorithms) are \textbf{cache-adaptive} for external-memory applications, i.e., do not degrade in the face of memory fluctuations~\ref{paper:esa22}. These dynamic memory fluctuations are common in most modern shared-memory and cloud systems. This work closes the logarithmic I/O-performance gap between (a,b,c)-regularity and cache-adaptivity previously shown in theory. \href{https://github.com/ArghyaB118/cache_adaptivity}{\textbf{[code]}} The journal version of the work builds an empirical framework to extend the study of the cache-adaptivity of external-memory algorithms in a \textbf{multi-threading ecosystem} [Manuscript in preparation]. \href{https://github.com/ArghyaB118/threading_ecosystems}{\textbf{[code]}}}

%\item \justifying{\textbf{Cache-efficient algorithms:} Designed an empirical framework to evaluate when $(a,b,c)$-regular algorithms (a class of recursive and cache-oblivious algorithms) are cache-efficient as external memory algorithms and do not degrade in the face of memory fluctuations that are common in most modern shared-memory and cloud systems~\ref{paper:esa22}. This work closes the logarithmic performance gap previously shown in theory. \href{https://github.com/ArghyaB118/cache_adaptivity}{\textbf{[code]}}} 
...
\item \justifying{\textbf{ML advised algorithms:} Redesigned traditional online algorithms for \textbf{rent-or-buy} problems with augmentation by single and multiple ML oracles~\ref{paper:walcom22}; the journal version deals with a more generalized version of the problem with an arbitrarily fluctuating discount on the rent of the resource~\ref{paper:tcs22}.
...
The follow-up work revisits conventional online decision-making problems, such as secretary selection problems~\ref{paper:grd22}, green paging, parallel paging, and list access problem, and design ML-advised algorithms with improved performance [Manuscript in preparation]. \href{https://github.com/ArghyaB118/ml-advice}{\textbf{[code]}}}

\item \justifying{\textbf{Filesystem aging:} Evaluated microbenchmarks and application-level fragmentation benchmarks to measure slowdown in the random read performance for several production filesystems (\texttt{ext4}, \texttt{btrfs}, \texttt{xfs}, \texttt{zfs}, and \texttt{f2fs}) as well as a $B^{\varepsilon}$-tree based write-optimized in-kernel filesystem \texttt{BetrFS} \ref{paper:tocs22}. \href{https://github.com/ArghyaB118/filesystem_aging}{\textbf{[code]}}}
\resumeItemListEnd
