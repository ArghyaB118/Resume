...
\resumeSubHeadingListStart
\resumeSubheading{Stony Brook University}{Stony Brook,NY}{Research Project Assistant}{Summer 2019 - Present}
\resumeItemListStart
\item \justifying{\textbf{Cache-efficient algorithms:} Designed an empirical framework to evaluate when $(a,b,c)$-regular cache-oblivious algorithms are cache-efficient as external memory algorithms and do not degrade in the face of memory fluctuations that are common in most modern systems. \hyperref[sec:pubs]{[Manuscript prepared to be submitted in VLDB'22]} \href{https://github.com/ArghyaB118/cache_adaptivity}{\textbf{[code]}}} 
...
\item \justifying{\textbf{Filesystem aging:} Evaluated microbenchmarks and application-level fragmentation benchmarks to measure slowdown in the random read performance for several production filesystems (\textit{ext4}, \textit{btrfs}, \textit{xfs}, \textit{zfs}, and \textit{f2fs}) as well as a $B^{\varepsilon}$-tree based write-optimized in-kernel filesystem \textit{BetrFS}. \hyperref[sec:pubs]{[Article submitted in ACM TOCS]} \href{https://github.com/ArghyaB118/filesystem_aging}{\textbf{[code]}}}
\item \justifying{\textbf{Machine-learning augmented algorithms:} Redesigned traditional online algorithms for rent-or-buy problems with augmentation by single and multiple machine learning oracles \hyperref[sec:pubs]{[Paper published in WALCOM'22]} and working on designing green paging and parallel paging algorithms with ML augmentation [Manuscript in preparation].}
\resumeItemListEnd
...
\label{sec:pubs}
\resumeSubHeadingListStart
\item{\textbf{Bhattacharya, A.}, Das, R. {``Machine Learning Advised Ski Rental Problem with a Discount,''} \href{https://walcom2022.unej.ac.id/instruction-for-author/accepted-papers}{\textit{16th International Conference and Workshops on Algorithms and Computation (WALCOM'22)}}.}
