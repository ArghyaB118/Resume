...
\begin{flushleft}
\includegraphics[width=0.58\textwidth,height=0.75\textwidth]{Figures/website.jpg}
\end{flushleft}
\end{minipage}
...
\resumeSubheading{Stony Brook University}{Stony Brook, NY}{Research Assistant}{Summer 2019 - Present}
\resumeItemListStart
\item \justifying{\textbf{Cache-efficient algorithms:} Designed theoretically good cache-efficient external memory algorithms that do not degrade in the face of memory fluctuations that are common in the most modern systems.} 
\item \justifying{\textbf{Threading ecosystem:} Built a framework to evaluate the performance of external memory algorithms with multi-threading in a multi-program environment.}
\item \justifying{\textbf{Filesystem aging:} Evaluated microbenchmarks and application-level fragmentation benchmarks to measure slowdown in the random read performance for several production filesystems (ext4, btrfs, xfs, zfs, and f2fs) as well as a write-optimized in-kernel filesystem \textit{BetrFS}.}
\item \justifying{\textbf{Machine-learning augmented algorithms:} Redesigned traditional online algorithms for rent-or-buy problems with augmentation by single and multiple machine learning oracles.}
%\item \justifying{My notes on \textit{Balls and Bins} problems and \textit{Tail Inequalities} are \href{https://sites.google.com/view/arghyab/research}{here}.}
\resumeItemListEnd

\resumeSubheading{High School Women in Science and Engineering (HS-WISE)}{Stony Brook, NY}{Mentor}{Fall 2019 - Present}
\resumeItemListStart
\item {Lesson: Basics of probability and Thinking algorithmically.}
...
\resumeItemListStart
\item {Advised by \href{https://www.ece.nus.edu.sg/gems/profhome.html}{Prof. Dipti Srinivasan}, Centre for Green Energy Management \& Smart Grid (GEMS), Dept.\ of Electrical and Computer Engineering.}
\item {Performance of multi-objective optimization algorithms using evolutionary computation based on decomposition techniques.}
\resumeItemListEnd
...
\resumeSubheading{Indian Institute of Technology, Kharagpur}{Kharagpur, India}
